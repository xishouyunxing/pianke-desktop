...
const TEST_IMAGE_DATA_URL: &str = "data:image/jpeg;base64,";
...
impl ProviderConfig {
    ...
    fn endpoint(&self, path: &str) -> Result<String, ApiError> {
        let base = trim_trailing_slashes(&self.base_url);
